...
class TestGetLocalPackagePaths(unittest.TestCase):
    ...
    def test_get_local_package_paths(self, mock_stat, mock_glob):
        self.assertCountEqual(['adir', 'moredir'],
                              spectreesut.get_local_package_paths('*'))
...
class TestDetermineSpecTreeStyle(unittest.TestCase):
    ...
    def test_get_local_package_paths_massive(self, mock_stat, mock_glob):
        self.assertEqual(spectreesut.SpecStyle.SPEC_STYLE_MASSIVE,
                         spectreesut.determine_spec_tree_style('*'))
    ...
    def test_get_local_package_paths_individual(self, mock_stat, mock_glob):
        self.assertEqual(spectreesut.SpecStyle.SPEC_STYLE_INDIVIDUAL,
                         spectreesut.determine_spec_tree_style('*'))
    ...
    def test_get_local_package_paths_speconly(self, mock_stat, mock_glob):
        self.assertEqual(spectreesut.SpecStyle.SPEC_STYLE_SPEC_ONLY,
                         spectreesut.determine_spec_tree_style('*'))
    ...
    def test_get_local_package_paths_unknown(self, mock_stat, mock_glob):
        self.assertEqual(spectreesut.SpecStyle.SPEC_STYLE_UNKNOWN,
                         spectreesut.determine_spec_tree_style('*'))
...
class TestMakeSpecPath(unittest.TestCase):
    ...
    def test_make_spec_path_massive(self):
        self.assertEqual('/path/to/mypackage/current/SPECS/mypackage.spec',
                         spectreesut.make_spec_path('/path/to/mypackage',
                                                    spectreesut.SpecStyle.SPEC_STYLE_MASSIVE))

    def test_make_spec_path_individual(self):
        self.assertEqual('/path/to/myindividualpackage/SPECS/myindividualpackage.spec',
                         spectreesut.make_spec_path('/path/to/myindividualpackage',
